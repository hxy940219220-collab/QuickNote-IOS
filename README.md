...
QuickNote 是一款本地优先的 macOS 便签工具。双击 Command 随手记下灵感，让小鸟 Pip 接住语音和文件，再把零散内容整理成清晰的笔记。记录、查找和 AI 辅助，都围绕一个轻巧的便签窗口展开。

> 当前支持 **macOS 14+**。仓库名为 `QuickNote-IOS`，尚未提供 iPhone / iPad 版本。

![新版 QuickNote：文件夹侧栏、富文本便签与右下角翻页按钮](docs/images/overview.png)

*以下图片由当前源码界面生成，均使用演示数据；语音整理结果为示例，不代表识别准确率。*
...
<p>
  <img src="docs/images/pip.png" width="120" alt="Pip 小鸟桌宠" />
  <img src="docs/images/pip-bubble.png" width="252" alt="Pip 状态气泡：灵感来了？说给我听，也可以拖进来。" />
</p>
...
<img src="docs/images/voice.png" width="540" alt="新版语音面板：自动分段后的文字，以及一键复制和存入笔记按钮" />
...
<img src="docs/images/search.png" width="540" alt="新版搜索浮层：放大镜搜索框、最近便签和文件夹信息" />

## AI 辅助，按需使用

- **划词处理**：选中文字后按 Option + Space，使用解释、分析、翻译或拓展，结果可导入便签。
- **截图识图**：按 Command + Shift 选择屏幕区域，提取文字、总结要点、翻译、整理表格或生成待办。
